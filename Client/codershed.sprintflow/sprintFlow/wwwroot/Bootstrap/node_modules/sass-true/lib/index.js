...
const parse = function (rawCss, ctxLines) {
    ...
    const parseAssertionContained = function (rule, ctx) {
        var _a, _b;
        if ((0, utils_1.isCommentNode)(rule) &&
            ((_a = rule.comment) === null || _a === void 0 ? void 0 : _a.trim()) === constants.CONTAINED_END_TOKEN) {
            /* istanbul ignore else */
            if (ctx.currentAssertion) {
                ctx.currentAssertion.expected = (0, css_tools_1.stringify)({
                    type: css_tools_1.CssTypes.stylesheet,
    ...
    const parseAssertionContainsString = function (rule, ctx) {
        var _a, _b, _c;
        if ((0, utils_1.isCommentNode)(rule) &&
            ((_a = rule.comment) === null || _a === void 0 ? void 0 : _a.trim()) === constants.CONTAINS_STRING_END_TOKEN) {
            /* istanbul ignore else */
            if (ctx.currentAssertion) {
                ...
                ctx.currentAssertion.expected = (0, css_tools_1.stringify)({
                    ...
                    .replace(new RegExp('\\*/$'), '')
                    .trim();
                ctx.currentAssertion.passed = (_b = ctx.currentAssertion.output) === null || _b === void 0 ? void 0 : _b.includes(ctx.currentAssertion.expected);
                ctx.currentAssertion.assertionType = 'contains-string';
            }
            delete ctx.currentExpectedRules;
            return parseEndAssertion;
        }
        (_c = ctx.currentExpectedRules) === null || _c === void 0 ? void 0 : _c.push(rule);
        return parseAssertionContainsString;
    };
    return parseCss();
};
